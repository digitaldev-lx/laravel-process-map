...
#[Title('Get process recommendations')]
#[Description('Returns the recommendations attached to a single process.')]
#[IsReadOnly]
final class GetProcessRecommendationsTool extends AbstractProcessMapTool
{
    /**
    ...
    protected function run(Request $request): array
    {
        ...
        return [
            ...
            'recommendations' => array_values((array) ($process['recommendations'] ?? [])),
        ];
    }
}
